...
public class MathCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета метода difAndDivision равен: " + difAndDivision(10, 2));
        System.out.println("Результат расчета метода sumAllOperations равен: " + sumAllOperations(10, 2));
    }
}
